...
const API_BASE = 'https://dlvohva9oe.execute-api.ap-northeast-1.amazonaws.com/prod/'; // ← 空のままだとローカル保存にフォールバックします
const IMG_BASE = 'https://dglsiiayaw6sm.cloudfront.net'; // ImagesCdnUrl（末尾スラ無し）
